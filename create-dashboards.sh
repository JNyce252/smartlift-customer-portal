...
cat > src/pages/internal/Dashboard.jsx << 'EOF'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-green-600 to-green-700 rounded-lg p-6">
            ...
            <p className="text-green-100">3 follow-ups scheduled</p>
          </div>
        </div>
...
import { Home, Wrench, FileText, DollarSign, LogOut } from 'lucide-react';
import { Link } from 'react-router-dom';
import { useAuth } from '../../context/AuthContext';
...
const CustomerDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h2 className="text-3xl font-bold text-white mb-8">Welcome, {user?.name || 'Customer'}!</h2>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Link to="/customer/service-request" className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-lg p-6 hover:from-blue-700 hover:to-blue-800 transition-all">
            <Wrench className="w-8 h-8 text-white mb-3" />
            <h3 className="text-xl font-bold text-white mb-2">Request Service</h3>
            <p className="text-blue-100">Submit a new service ticket</p>
          </Link>

          <Link to="/customer/maintenance" className="bg-gradient-to-br from-green-600 to-green-700 rounded-lg p-6 hover:from-green-700 hover:to-green-800 transition-all">
            <FileText className="w-8 h-8 text-white mb-3" />
            <h3 className="text-xl font-bold text-white mb-2">Maintenance History</h3>
            <p className="text-green-100">View service records</p>
          </Link>

          <Link to="/customer/billing" className="bg-gradient-to-br from-purple-600 to-purple-700 rounded-lg p-6 hover:from-purple-700 hover:to-purple-800 transition-all">
            <DollarSign className="w-8 h-8 text-white mb-3" />
            <h3 className="text-xl font-bold text-white mb-2">Billing & Payments</h3>
            <p className="text-purple-100">Manage invoices</p>
          </Link>
          ...
          <div className="bg-gradient-to-br from-amber-600 to-amber-700 rounded-lg p-6">
            ...
            <p className="text-amber-100">3 elevators registered</p>
          </div>
        </div>
      </div>
    </div>
