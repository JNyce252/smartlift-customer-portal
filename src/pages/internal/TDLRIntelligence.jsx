            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-white flex items-center gap-2">
                  TDLR Intelligence
                  <span className="px-2 py-0.5 bg-purple-900/30 border border-purple-700/30 text-purple-400 text-xs rounded-full font-medium">
                    {counts.total ? parseInt(counts.total).toLocaleString() : '37,949'} records
                  </span>
                </h1>
                <p className="text-xs text-gray-400">Texas elevator compliance — live sales intelligence</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <button onClick={() => fetchRecords(true)} className="p-2 bg-gray-700 hover:bg-gray-600 text-gray-300 rounded-lg transition-colors">
