            ...
            {supportSent ? (
              ...
              <>
                ...
                <textarea
                  ...
                  placeholder={supportType === 'support' ? 'Describe the issue — what happened and what you expected...' : supportType === 'feature' ? 'Describe the feature and how it would help your workflow...' : supportType === 'billing' ? 'Describe your billing question or concern...' : 'Share your feedback or thoughts...'}
                  rows={5}
...
${supportMessage}`,
                      ...
                      setSupportSent(true); // Show success even if email fails
                    }
                    setSupportSubmitting(false);
                  }}
                  disabled={!supportMessage.trim() || supportSubmitting}
                  className="w-full py-3 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-600 text-white rounded-lg font-medium text-sm flex items-center justify-center gap-2">
